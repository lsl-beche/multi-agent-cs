...
_STRONG_TRIGGERS: dict[str, list[str]] = {
    "price_inquiry": ["多少钱一斤", "多少钱", "什么价格", "价格多少", "贵不贵", "为什么贵", "便宜吗"],
    "track_logistics": ["物流", "快递", "包裹", "到哪了", "什么时候到", "什么时候收到", "发货了吗", "发货时间"],
    "return_goods": ["退货", "退款", "七天无理由", "申请售后", "坏了", "破损", "发错", "不想要", "少发了"],
    "exchange_goods": ["换货", "换一件", "换款", "发错了", "更换"],
    "promotion_consult": ["优惠券", "满减", "折扣", "活动", "会员", "积分"],
    "app_usage": ["打不开", "登录不上", "验证码", "闪退", "报错", "加载不了", "怎么使用", "如何使用"],
